            ...
            <div class="container-fluid text-center admin-pet">   
                <div class="row justify-content-center">
                    <div class="col-sm-5 col-md-5 col-lg-5" style="text-align: left; color:#ae1d1d;">                    
                        <h5><strong>Utilizatori</strong></h5>
                    </div>
                    <div class="col-sm-5 col-md-5 col-lg-5" style="text-align: right;">                    
                        <a href="admin_actionUser.php" class="btn btn-primary"> Adauga utilizator <i class="bi bi-plus-circle"></i></a>
                    </div>
                </div>
                <div class="row justify-content-center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="admin_actionUser.php" class="btn btn-secondary"> Editeaza <i class="bi bi-pencil-square"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
