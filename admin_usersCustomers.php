            ...
            <div class="container-fluid text-center admin-pet">   
                <div class="row justify-content-center">
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-5" style="text-align: right;">                    
                        <a href="admin_actionUser.php" class="btn btn-primary"> Adauga utilizator nou <i class="bi bi-plus-circle"></i></a>
                    </div>
                </div>
                <div class="row" >
                    <form class="form-inline" method="get" action="">
                        <div class="row" style="text-align:left;">
                            ...
                            <div class="col-lg-1">
                                <a href="admin_usersCustomers.php" class="btn btn-primary" id="cancel" hidden>Inapoi</a>
                            </div>
                        </div>
                    </form>
                </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $sqlv = "SELECT * FROM users WHERE  users.nume LIKE ('%$values%')";
                                        $resultv= mysqli_query($conn,"SELECT * FROM users WHERE  users.nume LIKE ('%$values%') LIMIT $start, $limit");
                                    ...
                                    else
                                    {
                                        ...
                                        $resultv= mysqli_query($conn,"SELECT * FROM users LIMIT $start, $limit");
                                    }
                                    ...
                                    else 
                                    {
                                        ...
                                        while ($myrow=mysqli_fetch_array($resultv,MYSQLI_ASSOC))
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo $myrow['data_inscriere']?>  </td>
                                                <td> 
                                                    <a href="admin_actionUser.php?id=<?php echo $myrow['id'];?>" class="btn btn-secondary"> Editeaza <i class="bi bi-pencil-square"></i></a> 
                                                    <a href="includes/admin/admin_deleteUser.inc.php?id=<?php echo $myrow['id'];?> "class="btn btn-secondary"> Sterge <i class="bi bi-pencil-square"></i></a>  
                                                </td>
                                            </tr>
                                        <?php
                                        }
                                        ...
                                        if(isset($_GET['search'])){
                                            ...
                                            echo ' <tr><td colspan="8"><a href="admin_usersCustomers.php" class="btn btn-primary" id="cancel"> Inapoi</a></td></tr>';
                                        }
